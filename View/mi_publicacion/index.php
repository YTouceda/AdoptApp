    ...
    <main>
      <div class="container text-center cuerpo">
        <div id="mi_publicacion">
          ...
          <a href="<?php echo constant('URL'); ?>editar_publicacion?publicacion=<?php echo $this->mascota->id_mascota;?>"><button id="boton" class="btn btn-secondary m-2">Editar Publicacion</button></a>
