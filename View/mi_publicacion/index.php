      ...
      <div class="container text-center cuerpo">
        <div id="mi_publicacion">
          ...
          <div class="card mb-3" id="container-publicacion">
            <div class="row g-0">
              <div class="col-md-4">
                <img src="<?php echo constant('URL')."public/public_media/".$this->mascota->getFotos_mascota();?>" class="img-fluid rounded-start my-4">
              </div>
              <div class="col-md-8">
                <div class="card-body">
                  <h5 class="card-title"><?php echo $this->mascota->getNombre_mascota();?></h5>
                  <p class="card-text"><?php echo $this->mascota->getDescripcion_mascota();?></p>
                  <p class="card-text"><small class="text-muted"><?php echo $this->publicacion->getFecha_alta_publicacion();?></small></p>
                  <div id="tipo-mascota">
                    <table class="table">
                      <tbody>
                        <tr>
                          <th scope="row">Nombre:</th>
                          <td><?php echo $this->mascota->getNombre_mascota();?></td>
                        ...
                        <tr>
                            ...
                            <td><?php echo $this->publicacion->getNum_contacto_publicacion();?></td>
                            <td><i class="fas fa-phone" aria-hidden="true"></i></td>
                        </tr> 
                        <tr>
                            <th scope="row">Sexo:</th>
                            <td><?php echo $this->mascota->getSexo_mascota();?></td>
                            <td><i class="fas fa-mars" aria-hidden="true"></i></td>
                        </tr>
                        <tr>
                            <th scope="row">Tamaño:</th>
                            <td><?php echo $this->mascota->getTamanio_mascota();?></td>
