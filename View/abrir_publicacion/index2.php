      ...
      <main>
        <div class="container cuerpo">
            ...
            <?php 
                ...
                <?php if($_SESSION['id']!=$this->publicacion->getId_usuario()){ 
                              ...
                              <div class="modal-body">
                                <form action="<?php echo constant('URL'); ?>abrir_publicacion/denunciar" method="post" id="formdenuncia">
                                  <div>
                                      ...
                                      <div class="error invalid-feedback" id="errorSelectDenuncia">Debe elegir una opcion valida.</div>
                                      ...
                                      <div class="modal-footer">
                                        <div class="row">
                                          ...
                                          <div class="col"><button type="button" id="enviar" class="btn btn-primary">Enviar denuncia</button></div>
                                        </div>
                                      </div>
                                  </div>
                                </form>
                    ...
                    <?php
                      ...
                      <?php if($_SESSION['id']==$this->publicacion->getId_usuario()){ ?>
                    <button type="button" class="btn btn-danger col-12 col-sm-6" data-bs-toggle="modal" data-bs-target="#eliminarModal">Eliminar publicación</button>
                ...
                if ($_SESSION['id']==$this->publicacion->getId_usuario()){?>
                  <a href='<?php echo constant('URL'); ?>editar_publicacion?publicacion=<?php echo  $this->publicacion->getId_publicacion();?>'><button id='boton' class='btn btn-secondary col-12 col-sm-6'>Editar Publicacion</button></a>
                <?php
                }?>
