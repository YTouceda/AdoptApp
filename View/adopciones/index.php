                    ...
                    <form id="form-filtro" class="form formulario row justify-content-md-center" action="adopciones" method="POST">
                        ...
                        <div class="col">
                            ...
                            <div name="tipo" class="form-check form-check-inline checkbox">
                                <input type="checkbox" id="perro" name="TIPO_ESPECIE_MASCOTA[]" value="Perro/a" class="form-check-input" <?php if(isset($_POST["TIPO_ESPECIE_MASCOTA"])){for($i=0;$i<count($_POST["TIPO_ESPECIE_MASCOTA"]);$i++){if($_POST["TIPO_ESPECIE_MASCOTA"][$i] == "Perro/a")echo "checked";}}?>>
                                <label for="perro" class="form-check-label"><i class="fas fa-dog"></i>- Perro/a</label><br>
                                <input type="checkbox" id="gato" name="TIPO_ESPECIE_MASCOTA[]" value="Gato/a" class="form-check-input" <?php if(isset($_POST["TIPO_ESPECIE_MASCOTA"])){for($i=0;$i<count($_POST["TIPO_ESPECIE_MASCOTA"]);$i++){if($_POST["TIPO_ESPECIE_MASCOTA"][$i] == "Gato/a")echo "checked";}}?>>
                        ...
                        <div class="col">
                            ...
                            <div id="tamanio" name="tamanio" class="form-check form-check-inline checkbox">
                                <input type="checkbox" id="chico" name="TAMANIO_MASCOTA[]" value="Chico" class="form-check-input" <?php if(isset($_POST["TAMANIO_MASCOTA"])){for($i=0;$i<count($_POST["TAMANIO_MASCOTA"]);$i++){if($_POST["TAMANIO_MASCOTA"][$i] == "Chico")echo "checked";}}?>>
                                <label for="chico" class="form-check-label">Chico/a</label><br>
                                <input type="checkbox" id="mediano" name="TAMANIO_MASCOTA[]" value="Mediano" class="form-check-input" <?php if(isset($_POST["TAMANIO_MASCOTA"])){for($i=0;$i<count($_POST["TAMANIO_MASCOTA"]);$i++){if($_POST["TAMANIO_MASCOTA"][$i] == "Mediano")echo "checked";}}?>>
                                <label for="mediano" class="form-check-label">Mediano/a</label><br>
                                <input type="checkbox" id="grande" name="TAMANIO_MASCOTA[]" value="Grande" class="form-check-input" <?php if(isset($_POST["TAMANIO_MASCOTA"])){for($i=0;$i<count($_POST["TAMANIO_MASCOTA"]);$i++){if($_POST["TAMANIO_MASCOTA"][$i] == "Grande")echo "checked";}}?>>
                        ...
                        <div class="col">
                            ...
                            <div name="sexo" class="form-check form-check-inline checkbox">
                                <input type="checkbox" id="hembra" name="SEXO_MASCOTA[]" value="Hembra" class="form-check-input" <?php if(isset($_POST["SEXO_MASCOTA"])){for($i=0;$i<count($_POST["SEXO_MASCOTA"]);$i++){if($_POST["SEXO_MASCOTA"][$i] == "Hembra")echo "checked";}}?>>
                                <label for="hembra" class="form-check-label">Hembra</label><br>
                                <input type="checkbox" id="macho" name="SEXO_MASCOTA[]" value="Macho" class="form-check-input" <?php if(isset($_POST["SEXO_MASCOTA"])){for($i=0;$i<count($_POST["SEXO_MASCOTA"]);$i++){if($_POST["SEXO_MASCOTA"][$i] == "Macho")echo "checked";}}?>>
                        ...
                        <div class="col">
                            ...
                            <div name="edad" class="form-check form-check-inline checkbox">
                                <input type="checkbox" id="cachorro" name="EDAD_MASCOTA[]" value="Cachorro/a" class="form-check-input" <?php if(isset($_POST["EDAD_MASCOTA"])){for($i=0;$i<count($_POST["EDAD_MASCOTA"]);$i++){if($_POST["EDAD_MASCOTA"][$i] == "Cachorro/a")echo "checked";}}?>>
                                <label for="cachorro" class="form-check-label">Cachorro/a</label><br>
                                <input type="checkbox" id="adulto" name="EDAD_MASCOTA[]" value="Adulto/a" class="form-check-input" <?php if(isset($_POST["EDAD_MASCOTA"])){for($i=0;$i<count($_POST["EDAD_MASCOTA"]);$i++){if($_POST["EDAD_MASCOTA"][$i] == "Adulto/a")echo "checked";}}?>>
                                <label for="adulto" class="form-check-label">Adulto/a</label><br>
                                <input type="checkbox" id="anciano" name="EDAD_MASCOTA[]" value="Anciano/a" class="form-check-input" <?php if(isset($_POST["EDAD_MASCOTA"])){for($i=0;$i<count($_POST["EDAD_MASCOTA"]);$i++){if($_POST["EDAD_MASCOTA"][$i] == "Anciano/a")echo "checked";}}?>>
                        ...
                        <div class="col col-12">
                            <div class="m-3 text-center">
                                <?php if($_POST){
                                ?>
                                    <a href="<?php echo constant('URL'); ?>adopciones"><input type="button" id="boton2" value="Quitar Filtros" class="btn btn-secondary mx-2"></a>
                                            ...
                                            <form id="form-filtro-modal" class="form row g-3 formulario"  action="adopciones" method="POST">
                                                <div class="row justify-content-md-center">
                                                    ...
                                                    <div class="col  col-12">
                                                        ...
                                                        <div name="tipo" class="form-check form-check-inline checkbox">
                                                            <input type="checkbox" id="mdl-perro" name="TIPO_ESPECIE_MASCOTA[]" value="Perro/a" class="form-check-input" <?php if(isset($_POST["TIPO_ESPECIE_MASCOTA"])){for($i=0;$i<count($_POST["TIPO_ESPECIE_MASCOTA"]);$i++){if($_POST["TIPO_ESPECIE_MASCOTA"][$i] == "Perro/a")echo "checked";}}?>>
                                                            <label for="mdl-perro" class="form-check-label"><i class="fas fa-dog"></i>- Perro/a</label>
                                                            <input type="checkbox" id="mdl-gato" name="TIPO_ESPECIE_MASCOTA[]" value="Gato/a" class="form-check-input" <?php if(isset($_POST["TIPO_ESPECIE_MASCOTA"])){for($i=0;$i<count($_POST["TIPO_ESPECIE_MASCOTA"]);$i++){if($_POST["TIPO_ESPECIE_MASCOTA"][$i] == "Gato/a")echo "checked";}}?>>
                                                    ...
                                                    <div class="col  col-12">
                                                        ...
                                                        <div name="tamanio" class="form-check form-check-inline checkbox">
                                                            <input type="checkbox" id="mdl-chico" name="TAMANIO_MASCOTA[]" value="Chico" class="form-check-input" <?php if(isset($_POST["TAMANIO_MASCOTA"])){for($i=0;$i<count($_POST["TAMANIO_MASCOTA"]);$i++){if($_POST["TAMANIO_MASCOTA"][$i] == "Chico")echo "checked";}}?>>
                                                            <label for="mdl-chico" class="form-check-label">Chico/a</label>
                                                            <input type="checkbox" id="mdl-mediano" name="TAMANIO_MASCOTA[]" value="Mediano" class="form-check-input" <?php if(isset($_POST["TAMANIO_MASCOTA"])){for($i=0;$i<count($_POST["TAMANIO_MASCOTA"]);$i++){if($_POST["TAMANIO_MASCOTA"][$i] == "Mediano")echo "checked";}}?>>
                                                            <label for="mdl-mediano" class="form-check-label">Mediano/a</label>
                                                            <input type="checkbox" id="mdl-grande" name="TAMANIO_MASCOTA[]" value="Grande" class="form-check-input" <?php if(isset($_POST["TAMANIO_MASCOTA"])){for($i=0;$i<count($_POST["TAMANIO_MASCOTA"]);$i++){if($_POST["TAMANIO_MASCOTA"][$i] == "Grande")echo "checked";}}?>>
                                                    ...
                                                    <div class="col  col-12">
                                                        ...
                                                        <div name="sexo" class="form-check form-check-inline checkbox">
                                                            <input type="checkbox" id="mdl-hembra" name="SEXO_MASCOTA[]" value="Hembra" class="form-check-input" <?php if(isset($_POST["SEXO_MASCOTA"])){for($i=0;$i<count($_POST["SEXO_MASCOTA"]);$i++){if($_POST["SEXO_MASCOTA"][$i] == "Hembra")echo "checked";}}?>>
                                                            <label for="mdl-hembra" class="form-check-label">Hembra</label>
                                                            <input type="checkbox" id="mdl-macho" name="SEXO_MASCOTA[]" value="Macho" class="form-check-input" <?php if(isset($_POST["SEXO_MASCOTA"])){for($i=0;$i<count($_POST["SEXO_MASCOTA"]);$i++){if($_POST["SEXO_MASCOTA"][$i] == "Macho")echo "checked";}}?>>
                                                    ...
                                                    <div class="col  col-12">
                                                        ...
                                                        <div name="edad" class="form-check form-check-inline checkbox">
                                                            <input type="checkbox" id="mdl-cachorro" name="EDAD_MASCOTA[]" value="Cachorro/a" class="form-check-input" <?php if(isset($_POST["EDAD_MASCOTA"])){for($i=0;$i<count($_POST["EDAD_MASCOTA"]);$i++){if($_POST["EDAD_MASCOTA"][$i] == "Cachorro/a")echo "checked";}}?>>
                                                            <label for="mdl-cachorro" class="form-check-label">Cachorro/a</label>
                                                            <input type="checkbox" id="mdl-adulto" name="EDAD_MASCOTA[]" value="Adulto/a" class="form-check-input" <?php if(isset($_POST["EDAD_MASCOTA"])){for($i=0;$i<count($_POST["EDAD_MASCOTA"]);$i++){if($_POST["EDAD_MASCOTA"][$i] == "Adulto/a")echo "checked";}}?>>
                                                            <label for="mdl-adulto" class="form-check-label">Adulto/a</label>
                                                            <input type="checkbox" id="mdl-anciano" name="EDAD_MASCOTA[]" value="Anciano/a" class="form-check-input" <?php if(isset($_POST["EDAD_MASCOTA"])){for($i=0;$i<count($_POST["EDAD_MASCOTA"]);$i++){if($_POST["EDAD_MASCOTA"][$i] == "Anciano/a")echo "checked";}}?>>
