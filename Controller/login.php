...
Class Login extends Controller{
    ...
    function Guardar_datos(){
        if(isset($_POST['Id']) && isset($_POST['Nombre']) && isset($_POST['Numero']) && isset($_POST['Email']) && isset($_POST['foto'])){
            ...
            if($this->model->insertUsuario(['ID_USUARIO' => $id_user, 'ID_ROL' => $this->view->usuario->getRol(), 'NOMBRE_USUARIO' => $this->view->usuario->getNombre(), 'NUM_CONTACTO_USUARIO' => $this->view->usuario->getNumero() ,'EMAIL_USUARIO' => $this->view->usuario->getEmail(),'FOTO_PERFIL' => $this->view->usuario->getFoto()])){
