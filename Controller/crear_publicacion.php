...
class Crear_Publicacion extends Controller{
    ...
    function registrarMascota(){
        $this->view->usuario->setUsuario($this->userSession->getCurrentUsuario());
       if($this->view->usuario->puede('Crear publicacion')){
        if(isset($_POST['sexo']) && isset($_POST['edad']) && isset($_POST['tamanio'])  && isset($_POST['especie'])  && isset($_POST['nombre'])  && isset($_POST['descripcion'])  && isset($_POST['estado']) && isset($_POST['provincia']) && isset($_POST['telefono']) && isset($_POST['localidad'])){
        ...
        if($check != false){
            ...
            if(isset($_POST['nombre'])){
                ...
                echo "Error, publicación no guardada. Datos incompletos.";
                }
        }else{
            echo "Error, no tienes permisos para crear publicaciones.";
        }
    }
